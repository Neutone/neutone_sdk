...
class CachedConv1d(nn.Module):
    def __init__(self,in_chan,out_chan,kernel,stride,padding,dilation=(1, ),
                 pad_mode="constant",weight_norm=False,bias=False):
        super().__init__()
...
class TCNBlock(nn.Module):
    def __init__(self, in_ch, out_ch, kernel_size=3, dilation=1):
        ...
        self.conv1  = CachedConv1d(in_ch, out_ch, kernel=kernel_size, stride=1, padding=padding, dilation=dilation, bias=True) 
...
class EffectModel(pl.LightningModule):
    def __init__(self, ninputs=1, noutputs=1, nblocks=4, channel_growth = 2, channel_width=0, kernel_size=3, dilation_growth=2, ncondition=2):
        ...
        for n in range(nblocks):
            ...
            self.blocks.append(TCNBlock(in_ch, out_ch, 
...
if __name__ == "__main__":
    ...
    model = EffectModel(ninputs=1, noutputs=1, nblocks=configs.nblocks, 
